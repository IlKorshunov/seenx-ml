...
class MultiVideoRetentionDataset(Dataset):
    def __init__(self, videos: list, processor, interval_len: int = 10, stride: int = 5):
        ...
        for vid in videos:
            ...
            retention_csv_path = vid["retention_csv_path"]

            retention_df = get_retention(video_path, retention_csv_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--retention_csv_path", type=str, required=True, help="retention CSV (time_ratio, audience_watch_ratio)")
    args = parser.parse_args()
    data = [{"video_path": args.video_path, "retention_csv_path": args.retention_csv_path}]
